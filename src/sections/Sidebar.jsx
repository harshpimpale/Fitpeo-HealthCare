    ...
    <div className="hidden lg:flex lg:w-64 lg:flex-col bg-white border-r border-gray-200 h-screen rounded-t-xl">
        ...
        <div className="flex-1 flex flex-col">
          <nav className="flex-1 px-4 py-6 space-y-1">
            ...
            <a href="#" className="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg hover:bg-cyan-50 text-gray-700">
              <BarChart3 className="w-5 h-5 mr-3" />
              Dashboard
            </a>
            <a href="#" className="flex items-center px-3 py-2.5 text-sm font-medium text-gray-600 rounded-lg hover:bg-gray-100 opacity-60">
